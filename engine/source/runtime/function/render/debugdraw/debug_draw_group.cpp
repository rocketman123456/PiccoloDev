...
namespace Piccolo
{
    ...
    void DebugDrawGroup::addTriangle(
        const Vector3& point0,
        const Vector3& point1,
    ...
    void DebugDrawGroup::addCylinder(
    ...
    void DebugDrawGroup::addCapsule(
        const Vector3& center,
