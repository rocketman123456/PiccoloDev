...
namespace Piccolo
{
    ...
    void AnimationComponent::tick(float delta_time)
    {
        ...
        // for (auto clip : m_animation_res.clips)
        // {
        //     if (clip->m_name == name)
        //     {
    ...
    //         return;
    //     }
    //     const auto& key_it    = m_signal.find(blend_state->key);
    //     double      key_value = 0;
    ...
    // {
    //
    //     for (auto& ratio : blend_state->blend_ratio)
    //     {
    //         ratio = desired_ratio;
    //     }
    //
    ...
    //     {
    //         AnimationPose pose(
    //             blendStateData.blend_clip[i], blendStateData.blend_weight[i], blendStateData.blend_ratio[i], blendStateData.blend_anim_skel_map[i]
    //         );
    //         m_skeleton.resetSkeleton();
    //         m_skeleton.applyAdditivePose(pose);
    //         m_skeleton.extractPose(pose);
    ...
    //     {
    //         for (auto& pose : poses[i].weight.blend_weight)
    //         {
    //             pose = blend_state->blend_weight[i];
    //         }
